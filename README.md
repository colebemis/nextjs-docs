[Primer](https://primer.style) documentation prototype built with [Next.js](https://nextjs.org/). This is a work in progress. Compare to [colebemis/astro-docs](https://github.com/colebemis/astro-docs).
